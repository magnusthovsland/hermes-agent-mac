# Preserved skill: design-md

Full package snapshot: `references/packages/design-md/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/design-md/`; use the files there if exact original support assets/scripts/templates are needed.
