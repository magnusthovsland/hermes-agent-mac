# Preserved skill: claude-design

Full package snapshot: `references/packages/claude-design/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/claude-design/`; use the files there if exact original support assets/scripts/templates are needed.
