# Preserved skill: popular-web-designs

Full package snapshot: `references/packages/popular-web-designs/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/popular-web-designs/`; use the files there if exact original support assets/scripts/templates are needed.
