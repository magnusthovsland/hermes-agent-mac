# Preserved skill: p5js

Full package snapshot: `references/packages/p5js/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/p5js/`; use the files there if exact original support assets/scripts/templates are needed.
