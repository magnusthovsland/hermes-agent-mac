# Preserved skill: baoyu-infographic

Full package snapshot: `references/packages/baoyu-infographic/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/baoyu-infographic/`; use the files there if exact original support assets/scripts/templates are needed.
