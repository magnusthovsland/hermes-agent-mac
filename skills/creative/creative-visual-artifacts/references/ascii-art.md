# Preserved skill: ascii-art

Full package snapshot: `references/packages/ascii-art/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/ascii-art/`; use the files there if exact original support assets/scripts/templates are needed.
