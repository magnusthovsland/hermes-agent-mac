# Preserved skill: pretext

Full package snapshot: `references/packages/pretext/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/pretext/`; use the files there if exact original support assets/scripts/templates are needed.
