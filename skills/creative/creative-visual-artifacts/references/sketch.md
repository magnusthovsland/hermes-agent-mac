# Preserved skill: sketch

Full package snapshot: `references/packages/sketch/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/sketch/`; use files there for exact original support assets/scripts/templates.
