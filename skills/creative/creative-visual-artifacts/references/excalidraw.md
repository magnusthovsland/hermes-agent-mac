# Preserved skill: excalidraw

Full package snapshot: `references/packages/excalidraw/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/excalidraw/`; use the files there if exact original support assets/scripts/templates are needed.
