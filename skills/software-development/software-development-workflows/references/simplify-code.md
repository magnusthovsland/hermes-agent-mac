# Preserved skill: simplify-code

Full package snapshot: `references/packages/simplify-code/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/simplify-code/`; use the files there if exact original support assets/scripts/templates are needed.
