# Preserved skill: node-inspect-debugger

Full package snapshot: `references/packages/node-inspect-debugger/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/node-inspect-debugger/`; use the files there if exact original support assets/scripts/templates are needed.
