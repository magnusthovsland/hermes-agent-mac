# Preserved skill: spike

Full package snapshot: `references/packages/spike/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/spike/`; use the files there if exact original support assets/scripts/templates are needed.
