# Preserved skill: python-debugpy

Full package snapshot: `references/packages/python-debugpy/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/python-debugpy/`; use the files there if exact original support assets/scripts/templates are needed.
