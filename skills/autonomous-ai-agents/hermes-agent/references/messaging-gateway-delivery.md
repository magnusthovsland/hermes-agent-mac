# Preserved skill: messaging-gateway-delivery

Full package snapshot: `references/packages/messaging-gateway-delivery/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/messaging-gateway-delivery/`; use files there for exact original support assets/scripts/templates.
