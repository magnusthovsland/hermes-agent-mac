# Preserved skill: heartmula

Full package snapshot: `references/packages/heartmula/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/heartmula/`; use the files there if exact original support assets/scripts/templates are needed.
