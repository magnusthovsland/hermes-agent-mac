# Preserved skill: songwriting-and-ai-music

Full package snapshot: `references/packages/songwriting-and-ai-music/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/songwriting-and-ai-music/`; use the files there if exact original support assets/scripts/templates are needed.
