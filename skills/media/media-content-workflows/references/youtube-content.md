# Preserved skill: youtube-content

Full package snapshot: `references/packages/youtube-content/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/youtube-content/`; use the files there if exact original support assets/scripts/templates are needed.
