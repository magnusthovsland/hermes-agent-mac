# Preserved skill: nano-pdf

Full package snapshot: `references/packages/nano-pdf/`

Original `SKILL.md` follows. Relative support-file links inside this copy refer to the package snapshot under `references/packages/nano-pdf/`; use the files there if exact original support assets/scripts/templates are needed.
